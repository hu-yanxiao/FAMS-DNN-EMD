...
@compile_mode("script")
class FAMS_DNN(torch.nn.Module):
    def __init__(
        self,
        r_max: float,
        num_bessel: int,
        ...
        max_ell: int,
        linear_gnn: Type[InteractionBlock],
        make_linear_basis: Type[InteractionBlock],
        ...
        **kwargs,
        ...
        ### make R_n() with Bessel or Guassian
        ...
        ### set block for Alm
        inter = make_linear_basis(
            node_attrs_irreps=zi,
            node_feats_irreps=mlp_zi,
        ...
        prod = EquivariantProductBasisBlock(
            node_feats_irreps=linear_basis_out,
